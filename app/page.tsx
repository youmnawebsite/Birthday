    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-teal-50 via-blue-50 to-purple-50 p-4 overflow-hidden">
      ...
      >
        ...
        <p className="text-lg mb-8 text-gray-700 leading-relaxed" style={{ direction: "rtl" }}>
          .عدا شهر كمان واحنا مش مع بعض بقينا تسع شهور يا يمنى عدو وانا متأكد ان طول التسع شهور حاولت معاكي بدل المره ألف واما جيبت اخري اللوم جه عليا انا وعدو التسع شهور وانا متأكد اني ولا قصرت معاكي ولا اذيتك عدا شهر كمان وانتي متعرفيش عني حاجه عدا شهر كمان وانا نفسي اسامحك
        </p>
        <p className="text-lg mb-8 text-gray-700 leading-relaxed" style={{ direction: "rtl" }}>
            مش عارف بصراحه هتخشي عالويبسايت اصلا ولا نسيتيه بس اكيد هييجي يوم وهتخشيه المهم ربنا يوفقك ويارب تبقي كويسه ومبسوطه وربنا يوفقك
        </p> 
        <p className="text-lg mb-8 text-gray-700 leading-relaxed" style={{ direction: "rtl" }}>
